...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=True):
        ...
        import math
        self.trial_num += 1
        self.epsilon = math.e**(-0.01 * self.trial_num)
        self.alpha = math.e**(-0.001 * (self.trial_num))
        if testing:
            self.epsilon = 0
            self.alpha = 0
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=False, alpha=0.6, epsilon=0.9)
