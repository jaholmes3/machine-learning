...
def symbol_to_path(symbol, base_dir=None):
    ...
    if base_dir is None:
        base_dir = os.environ.get("MARKET_DATA_DIR", '/Users/administrator/virtualenvs/projects/q_learning_trading/data')
...
def get_orders_data_file(basefilename):
    return open(os.path.join(os.environ.get("ORDERS_DATA_DIR",'~/virtualenvs/projects/q_learning_trading/orders/'),basefilename))
...
def get_exchange_days(start_date = dt.datetime(1964,7,5), end_date = dt.datetime(2020,12,31),
    dirpath = "../data", filename="NYSE_dates.txt"):
